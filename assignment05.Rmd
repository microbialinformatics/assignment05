...
1. In the local simulation, R and C have stable coexistence while S goes extinct.  In the original simulations, R helped S by keeping C's abundance low enough to allow stable coexistence of S, R, and C.  In this experiment, R's abundance is initially brought down by S because S beats R.  Once S goes extinct, R's abundance remains the same.  However, due to the inital influence of S, R's continues to have a lower abudance than C. 
