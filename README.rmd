...
4. 
5. neighborhoods include 8 cells surrounding a point, and neighborhoods of cells on the edge include distant cells (furthest away from index cell in the same plane)
