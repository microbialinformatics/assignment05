...
test.matrix<-matrix(seeds,nrow=50, ncol=50) #create matrix with random numbers
...
#problem!: this is not using previous matrix to fill 
#set up first run

#use results of first run to replicate and write to file
local.comp(test.matrix)
write.table(replicate(500,(local.comp(initial.matrix))),file="local.txt")
