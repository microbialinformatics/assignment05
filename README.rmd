...
plot(freq.matrix.t$"1",type="l", col="green",ylim=(c(0,5)),ylab="Log(abundance)",xlab="Time",main="Local neighbourhood", xlim=c(0,ncol(freq.matrix.t)))
lines(freq.matrix.t$"2", type="l", col="red")
lines(freq.matrix.t$"3", type="l", col="blue")
#plot the abundances
plot(abundance.1[1,],abundance.1[2,], type="l", 
