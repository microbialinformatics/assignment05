...
if(l.low.corner>10) l.low.corner<-1
  ...
  wrap.it.up<-function(up.row, down.row, r.up.corner, l.up.corner,center.r,center.l, r.low.corner,up.col,low.col,r.up.cor.col,l.up.cor.col,center.r.col,center.l.col, r.lower.cor.col,l.lower.cor.col)
    {
    #any are greater than max, make them 1
    
    return(up.row)
    #any are less than 1, make them max
    #otherwise leave them the same
  }
  wrap.it.up()
  up.row
