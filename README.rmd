...
local.comp<-function(initial.matrix, repeat.matrix) { 
  if(missing(repeat.matrix)){initial.matrix<-initial.matrix}
  else(initial.matrix<-repeat.matrix)
