...
#now to run the sampling scheme multiple times and save the matrices each time for the local competition
repeat.local.comp<-function(n){
  n<-10
rep((local.comp(initial.matrix)),n)
  }
