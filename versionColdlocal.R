...
# plot_abundance(output_update_local, 1000, "local")
...
#wrong update_local: output_update_local_25.14 (1000)
...
update_grid <- function(interaction, grid, size, updates, epochs_heatmap){
  ...
  shell("convert -delay 20 *.png local_25.9.gif")
