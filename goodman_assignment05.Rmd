...
abundance <- 1
for(i in 1:1000){
replicate(2500, simulation(matrix))
...
plot(abundance[1,], abundance[2,], type="l", col="green", ylim=c(1,4), ylab="Log (Abundance)", xlab="Time", main="Local Neighborhood")
lines(abundance[1,], abundance[3,], type="l", col="blue")
lines(abundance[1,], abundance[4,], type="l", col="red")
legend(x=0,y=2, c("R","S","C"), lty=c(1,1), lwd=c(2.5,2.5),col=c("green","blue","red"),cex=0.7)
