...
#### First step... generate a matrix, size 50x50, and fill it randomly with C, S, R, and empty spaces (E).
...
#### Pick random cell, sample surroundings, figure out what the cell will become, update matrix, 2500 updates per time step, output 1000 time steps in graphical form, local and global
...
###Experiment: If there are initially more S bacteria in a global environment, then will the S population die out as quickly as in the simulation where there are equal proportions of each type of bacteria and empty spaces

```{r echo=FALSE}
variable <- c("S", "R", "C", "E")
create.p.matrix <- function(variable, nrows=50,ncols=50){
	matrix(sample(variable, nrows*ncols, replace=TRUE, prob=c(0.5, 1/6, 1/6, 1/6)), nrow=nrows, ncol=ncols)
}
